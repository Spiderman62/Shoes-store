const form = {
	...
	selectors: [
		check_blank('#currentPassword'),
		check_length('#currentPassword', 6),
		check_blank('#newPassword'),
		check_length('#newPassword', 6),
		check_blank('#repeatPassword'),
		check_length('#repeatPassword', 6),
		check_match('#repeatPassword', () => document.querySelector('#newPassword').value.trim()),
	],
